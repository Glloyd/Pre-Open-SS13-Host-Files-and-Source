...
/obj/machinery/computer/atmosphere/siphonswitch/verb/siphon_all()
	...
	for(var/obj/machinery/atmoalter/siphs/S as obj in src.returnarea())
		S.reset(1, 0)
		//Foreach goto(39)
...
/obj/machinery/computer/atmosphere/siphonswitch/verb/release_scrubbers()
	...
	for(var/obj/machinery/atmoalter/siphs/scrubbers/S as obj in src.returnarea())
		S.reset(-1.0, 0)
		//Foreach goto(39)
	src.add_fingerprint(usr)
	return
...
/obj/machinery/atmoalter/heater/process()
	...
	if (src.h_status)
		...
		if ((t1 > 0 && src.temperature < src.h_tar))
...
/obj/machinery/atmoalter/heater/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/atmoalter/heater/attack_hand(user as mob)
...
/obj/machinery/atmoalter/heater/attackby(W as obj, user as mob)
...
/obj/machinery/atmoalter/canister/meteorhit(O as obj)

	src.health = 0
	healthcheck()
	return

/obj/machinery/atmoalter/canister/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/atmoalter/canister/attack_hand(user as mob)
	...
	switch(src.t_status)
		if(1.0)
			var/tt = text("Releasing <A href='?src=\ref[];t=2'>Siphon (only tank)</A> <A href='?src=\ref[];t=3'>Stop</A>", src, src)
		if(2.0)
...
/obj/machinery/atmoalter/canister/attackby(W as obj, user as mob)
