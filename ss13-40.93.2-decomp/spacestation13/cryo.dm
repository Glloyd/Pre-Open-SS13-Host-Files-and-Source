...
/obj/machinery/computer/med_data/attack_hand(user as mob)

	if (src.temp)
		var/dat = text("<TT>[]</TT><BR><BR><A href='?src=\ref[];temp=1'>Clear Screen</A>", src.temp, src)
	else
		...
		if (src.authenticated)
			switch(src.screen)
				...
				if(4.0)
					...
					if ((istype(R.active1, /datum/data/record) && data_core.general.Find(R.active1)))
						dat += text("Name: [] ID: []<BR>\nSex: <A href='?src=\ref[];field=sex'>[]</A><BR>\nAge: <A href='?src=\ref[];field=age'>[]</A><BR>\nFingerprint: <A href='?src=\ref[];field=fingerprint'>[]</A><BR>\nPhysical Status: <A href='?src=\ref[];field=p_stat'>[]</A><BR>\nMental Status: <A href='?src=\ref[];field=m_stat'>[]</A><BR>", src.active1.fields["name"], src.fields["id"], src, src.fields["sex"], src, src.fields["age"], src, src.fields["fingerprint"], src, src.fields["p_stat"], src, src.fields["m_stat"])
					else
						dat += "<B>General Record Lost!</B><BR>"
					if ((istype(src.active2, /datum/data/record) && data_core.medical.Find(src.active2)))
						dat += text("<BR>\n<CENTER><B>Medical Data</B></CENTER><BR>\nBlood Type: <A href='?src=\ref[];field=b_type'>[]</A><BR>\n<BR>\nMinor Disabilities: <A href='?src=\ref[];field=mi_dis'>[]</A><BR>\nDetails: <A href='?src=\ref[];field=mi_dis_d'>[]</A><BR>\n<BR>\nMajor Disabilities: <A href='?src=\ref[];field=ma_dis'>[]</A><BR>\nDetails: <A href='?src=\ref[];field=ma_dis_d'>[]</A><BR>\n<BR>\nAllergies: <A href='?src=\ref[];field=alg'>[]</A><BR>\nDetails: <A href='?src=\ref[];field=alg_d'>[]</A><BR>\n<BR>\nCurrent Diseases: <A href='?src=\ref[];field=cdi'>[]</A> (per disease info placed in log/comment section)<BR>\nDetails: <A href='?src=\ref[];field=cdi_d'>[]</A><BR>\n<BR>\nImportant Notes:<BR>\n\t<A href='?src=\ref[];field=notes'>[]</A><BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>", src, src.active2.fields["b_type"], src, src.fields["mi_dis"], src, src.fields["mi_dis_d"], src, src.fields["ma_dis"], src, src.fields["ma_dis_d"], src, src.fields["alg"], src, src.fields["alg_d"], src, src.fields["cdi"], src, src.fields["cdi_d"], src, src.fields["notes"])
						var/counter = 1
						while(src.active2.fields[text("com_[]", counter)])
							dat += text("[]<BR><A href='?src=\ref[];del_c=[]'>Delete Entry</A><BR><BR>", src.fields[text("com_[]", counter)], src, counter)
							counter++
									...
									switch(href_list["field"])
										if("fingerprint")
											if (istype(src.active1, /datum/data/record))
												...
												if ((!( t1 ) || (!( src.authenticated ) || (usr.stat || (restrained() || (get_dist(src, usr) > 1 || src.active1 != a1))))))
													return
												src.active1.fields["fingerprint"] = t1
										if("sex")
											if (istype(src.active1, /datum/data/record))
												if (src.active1.fields["sex"] == "Male")
													src.fields["sex"] = "Female"
												else
													src.fields["sex"] = "Male"
										if("age")
											if (istype(src.active1, /datum/data/record))
										...
										if("mi_dis")
											if (istype(src.active2, /datum/data/record))
												...
												if ((!( t1 ) || (!( src.authenticated ) || (usr.stat || (restrained() || (get_dist(src, usr) > 1 || src.active2 != a2))))))
													return
											...
											if (href_list["b_type"])
												...
												if (href_list["del_r"])
													...
													if (href_list["del_r2"])
														...
														if (href_list["d_rec"])
															var/R = locate(href_list["d_rec"])
															var/M = locate(href_list["d_rec"])
																			...
																			if (href_list["print_p"])
																				if (!( src.printing ))
																					...
																					if ((istype(src.active1, /datum/data/record) && data_core.general.Find(src.active1)))
																						P.info += text("Name: [] ID: []<BR>\nSex: []<BR>\nAge: []<BR>\nFingerprint: []<BR>\nPhysical Status: []<BR>\nMental Status: []<BR>", src.active1.fields["name"], src.fields["id"], src.fields["sex"], src.fields["age"], src.fields["fingerprint"], src.fields["p_stat"], src.fields["m_stat"])
																					else
																						P.info += "<B>General Record Lost!</B><BR>"
																					if ((istype(src.active2, /datum/data/record) && data_core.medical.Find(src.active2)))
																						P.info += text("<BR>\n<CENTER><B>Medical Data</B></CENTER><BR>\nBlood Type: []<BR>\n<BR>\nMinor Disabilities: []<BR>\nDetails: []<BR>\n<BR>\nMajor Disabilities: []<BR>\nDetails: []<BR>\n<BR>\nAllergies: []<BR>\nDetails: []<BR>\n<BR>\nCurrent Diseases: [] (per disease info placed in log/comment section)<BR>\nDetails: []<BR>\n<BR>\nImportant Notes:<BR>\n\t[]<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>", src.active2.fields["b_type"], src.fields["mi_dis"], src.fields["mi_dis_d"], src.fields["ma_dis"], src.fields["ma_dis_d"], src.fields["alg"], src.fields["alg_d"], src.fields["cdi"], src.fields["cdi_d"], src.fields["notes"])
																						var/counter = 1
																						while(src.active2.fields[text("com_[]", counter)])
																							P.info += text("[]<BR>", src.fields[text("com_[]", counter)])
																							counter++
																					else
...
/obj/machinery/computer/secure_data/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/computer/secure_data/attack_hand(user as mob)
																						...
																						if (href_list["print_p"])
																							if (!( src.printing ))
																								...
																								if ((istype(src.active1, /datum/data/record) && data_core.general.Find(src.active1)))
																									...
																									P.info += "<B>General Record Lost!</B><BR>"
																								if ((istype(src.active2, /datum/data/record) && data_core.security.Find(src.active2)))
																									P.info += text("<BR>\n<CENTER><B>Security Data</B></CENTER><BR>\nCriminal Status: []<BR>\n<BR>\nMinor Crimes: []<BR>\nDetails: []<BR>\n<BR>\nMajor Crimes: []<BR>\nDetails: []<BR>\n<BR>\nImportant Notes:<BR>\n\t[]<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>", src.active2.fields["criminal"], src.fields["mi_crim"], src.fields["mi_crim_d"], src.fields["ma_crim"], src.fields["ma_crim_d"], src.fields["notes"])
																									var/counter = 1
																									while(src.active2.fields[text("com_[]", counter)])
																										P.info += text("[]<BR>", src.fields[text("com_[]", counter)])
																										counter++
...
/obj/machinery/computer/sleep_console/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/computer/sleep_console/attack_hand(user as mob)

	if (src.connected)
		var/occupant = src.connected.occupant
...
/obj/machinery/freezer/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/freezer/attack_hand(user as mob)

	user.machine = src
	if ((istype(user, /mob/human) && (!( ticker ) || (ticker && ticker.mode != "monkey"))))
		if (locate(/obj/item/weapon/flasks, src))
			var/counter = 1
			for(var/obj/item/weapon/flasks/F as obj in src)
				var/d1 += text("<A href = '?src=\ref[];flask=[]'><B>Flask []</B></A>: [] / [] / []<BR>", src, counter, counter, F.oxygen, F.plasma, F.coolant)
				counter++
				//Foreach goto(78)
...
/obj/machinery/freezer/process()
	...
	if (src.contents.len >= 3)
		var/F3 = src.contents[3]
	if (src.contents.len >= 2)
		var/F2 = src.contents[2]
	if (src.contents.len >= 1)
		var/F1 = src.contents[1]
	var/u_cool = 0
	if (src.status)
		u_cool = src.c_used
		if ((F2 && F2.coolant))
...
/obj/machinery/freezer/attackby(F as obj, user as mob)
...
/obj/machinery/freezer/proc/rebuild_overlay()
	...
	var/counter = 0
	for(var/obj/item/weapon/flasks/F as obj in src.contents)
...
/obj/machinery/sleeper/attackby(G as obj, user as mob)
...
/obj/machinery/sleeper/proc/go_out()
	...
	if (src.occupant.client)
		src.eye = src.occupant.client.mob
...
/obj/machinery/sleeper/proc/inject(user as mob)
...
/obj/machinery/sleeper/proc/check(user as mob)
	...
	if (src.occupant)
		...
		user << text("[]\t -Respiratory Damage %: []", (src.oxyloss < 60 ? "\blue " : "\red "), src.occupant.oxyloss)
		user << text("[]\t -Toxin Content %: []", (src.toxloss < 60 ? "\blue " : "\red "), src.occupant.toxloss)
		user << text("[]\t -Burn Severity %: []", (src.fireloss < 60 ? "\blue " : "\red "), src.occupant.fireloss)
		user << "\blue Expected time till occupant can safely awake: (note: If health is below 20% these times are inaccurate)"
		user << text("\blue \t [] second\s (if around 1 or 2 the sleeper is keeping them asleep.)", src.paralysis / 5)
	else
...
/obj/machinery/sleeper/alter_health(M as mob)
...
/obj/machinery/cryo_cell/attackby(G as obj, user as mob)
...
/obj/machinery/cryo_cell/attack_paw(user as mob)

	return src.attack_hand(user)
	return

/obj/machinery/cryo_cell/attack_hand(user as mob)

	user.machine = src
	if (istype(user, /mob/human))
		var/dat = "<font color='blue'> <B>System Statistics:</B></FONT><BR>"
		if (src.gas.temperature > 0)
			dat += text("<font color='red'>\tTemperature (Farenheight): [] (MUST be below 0, add coolant to mixture)</FONT><BR>", src.temperature)
		else
			dat += text("<font color='blue'>\tTemperature(Farenheight): [] </FONT><BR>", src.temperature)
		if (src.gas.plasma < 1)
			dat += text("<font color='red'>\tPlasma Units: [] (Add plasma to mixture!)</FONT><BR>", src.plasma)
		else
			dat += text("<font color='blue'>\tPlasma Units: []</FONT><BR>", src.plasma)
		if (src.gas.oxygen < 1)
			dat += text("<font color='red'>\tOxygen Units: [] (Add oxygen to mixture!)</FONT><BR>", src.oxygen)
		else
			dat += text("<font color='blue'>\tOxygen Units: []</FONT><BR>", src.oxygen)
		if (src.occupant)
		...
		if (src.gas.temperature > 0)
			dat += text("<font color='red'>\t[]</FONT><BR>", stars(text("Temperature (Farenheight): [] (MUST be below 0, add coolant to mixture)", src.temperature)))
		else
			dat += text("<font color='blue'>\t[] </FONT><BR>", stars(text("Temperature(Farenheight): []", src.temperature)))
		if (src.gas.plasma < 1)
			dat += text("<font color='red'>\t[]</FONT><BR>", stars(text("Plasma Units: [] (Add plasma to mixture!)", src.plasma)))
		else
			dat += text("<font color='blue'>\t[]</FONT><BR>", stars(text("Plasma Units: []", src.plasma)))
		if (src.gas.oxygen < 1)
			dat += text("<font color='red'>\t[]</FONT><BR>", stars(text("Oxygen Units: [] (Add oxygen to mixture!)", src.oxygen)))
		else
			dat += text("<font color='blue'>\t[]</FONT><BR>", stars(text("Oxygen Units: []", src.oxygen)))
		if (src.occupant)
			dat += "<font color='blue'><B>Occupant Statistics:</B></FONT><BR>"
			var/t1 = null
			switch(src.occupant.stat)
...
/obj/machinery/cryo_cell/relaymove(user as mob)
...
/obj/machinery/cryo_cell/alter_health(M as mob)

	if (M.health < 0)
		if ((src.gas.temperature > 0 || src.plasma < 1))
			return
	if (M.stat == 2)
		return
	if (src.gas.oxygen >= 1)
	...
	if ((src.gas.temperature < 0 && src.plasma >= 1))
		...
		if (istype(M, /mob/human))
			...
			for(var/organ in H.organs)
				var/affecting = H.organs[text("[]", organ)]
	...
	if (src.gas.temperature < 60)
		src.temperature = min(src.temperature + 1, 60)
	for(var/E as mob in viewers(1, src))
...
/datum/data/function/proc/r_input(href, href_list, user as mob)
