...
/obj/item/weapon/sheet/glass/attackby(obj/item/weapon/sheet/glass/W as obj, mob/user as mob)
...
/obj/item/weapon/extinguisher/afterattack(target as mob|obj|turf|area, mob/user as mob, flag)
...
/atom/DblClick()
	...
	if ((istype(src, /obj/item/weapon/organ) && usr.contents.Find(src)))
		var/mob/human/H = usr
		usr << "Betchya think your really smart trying to remove your own body parts aren't ya!"
		if (istype(H, /mob/human))
