...
/obj/item/weapon/infra_sensor/proc/burst()
	...
	for(var/obj/beam/i_beam/I in range(src.loc, null))
		I.left = 10
		//Foreach goto(22)
	for(var/obj/item/weapon/infra/I in range(src.loc, null))
		I.visible = 1
		spawn( 0 )
			if ((I && I.first))
			...
			return
		//Foreach goto(69)
	for(var/obj/item/weapon/assembly/rad_infra/I in range(src.loc, null))
		I.part2.visible = 1
		spawn( 0 )
...
/obj/item/weapon/timer/attackby(obj/item/weapon/radio/signaler/S as obj, mob/user as mob)
